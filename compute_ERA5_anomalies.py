...
def compute_climatology():
    ...
    ERA5 = ERA5.sel(time=slice('1981-01-01', '2010-12-31'))

    # compute climatology
    clim_avg, clim_std = compute_climatology_stack(ERA5, dekad=True)
    clim_avg.to_netcdf('/mnt/CEPH_PROJECTS/ADO/SM/ERA5_ERA5l_QM/climatology/ERA5qm_clim_avg_1981_2010.nc')
    clim_std.to_netcdf('/mnt/CEPH_PROJECTS/ADO/SM/ERA5_ERA5l_QM/climatology/ERA5qm_clim_std_1981_2010.nc')
    clim_avg.close()
    clim_std.close()
...
def compute_anomalies():
    # load climatology
    clim_avg = xr.open_dataset('/mnt/CEPH_PROJECTS/ADO/SM/ERA5_ERA5l_QM/climatology/ERA5qm_clim_avg_1981_2010.nc')
    clim_std = xr.open_dataset('/mnt/CEPH_PROJECTS/ADO/SM/ERA5_ERA5l_QM/climatology/ERA5qm_clim_std_1981_2010.nc')
    ...
    for iy in range(2020, 2021):
        ...
        for id in anom_stack.time:
            outname = '/mnt/CEPH_PROJECTS/ADO/SM/ERA5_ERA5l_QM/anomalies_alternative/era5qm_sm_anom_' + \
